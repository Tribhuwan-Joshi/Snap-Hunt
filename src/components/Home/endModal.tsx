function EndModal() {
  return (
    <div className="h-screen z-[1000] w-screen fixed top-0 bg-gray-200/70">
      <div className=" rounded-lg text-center fixed translate-x-[-50%] translate-y-[-50%] left-[50%] top-[45%] border flex flex-col justify-between  p-2 border-white bg-gray-900/90 text-white gap-4 space-y-2">
